...
{
    private static final ResourceLocation field_147529_c = new ResourceLocation("faithcraft2:textures/environment/heaven_sky.png");
    private static final ResourceLocation field_147526_d = new ResourceLocation("faithcraft2:textures/entity/heaven_portal.png");
    private static final Random field_147527_e = new Random(31100L);
    FloatBuffer field_147528_b = GLAllocation.createDirectFloatBuffer(16);
    private static final String __OBFID = "CL_00002467";

    public void func_180544_a(TileEntityHeavenPortal p_180544_1_, double p_180544_2_, double p_180544_4_, double p_180544_6_, float p_180544_8_, int p_180544_9_)
    {
    ...
    {
        this.func_180544_a((TileEntityHeavenPortal)p_180535_1_, posX, posZ, p_180535_6_, p_180535_8_, p_180535_9_);
    }
}