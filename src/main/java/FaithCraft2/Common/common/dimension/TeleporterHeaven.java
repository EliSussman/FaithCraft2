        ...
        for (int l = -2; l <= 2; ++l)
        {
            for (int i1 = -2; i1 <= 2; ++i1)
            {
                for (int j1 = -1; j1 < 3; ++j1)
                {
                    ...
                    int i2 = k + i1 * b1 - l * b0;
                    boolean flag = j1 < 0;
                    this.worldServerInstance.setBlock(k1, l1, i2, Blocks.quartz_block);
                }
            }
        }
    ...
    else
    {
        for (k1 = l - short1; k1 <= l + short1; ++k1)
        {
            ...
            for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1)
            {
                ...
                {
                    if (this.worldServerInstance.getBlock(k1, i2, l1) == FaithCraft2.HeavenPortal)
                    {
                        while (this.worldServerInstance.getBlock(k1, i2 - 1, l1) == FaithCraft2.HeavenPortal)
                        {
                            --i2;
                        }
                        ...
                        for (j3 = 0; j3 < 3; ++j3)
                        {
                            for (i4 = 0; i4 < 4; ++i4)
                            {
                                for (l3 = -1; l3 < 4; ++l3)
                                {
                                    ...
                                    if (l3 < 0 && !this.worldServerInstance.getBlock(k4, j4, l4).isBlockSolid(worldServerInstance, l4, l4, l4, l4) || l3 >= 0 && !this.worldServerInstance.isAirBlock(k4, j4, l4))
                                    {
                                        continue label274;
                                    }
                                }
                        ...
                        for (i3 = l1; i3 < l1 + 2; ++i3)
                        {
                            ...
                            for (j3 = 0; j3 < 4; ++j3)
                            {
                                for (i4 = -1; i4 < 4; ++i4)
                                {
                                    ...
                                    if (i4 < 0 && !this.worldServerInstance.getBlock(l3, k4, j4).isBlockSolid(worldServerInstance, k4, k4, k4, k4) || i4 >= 0 && !this.worldServerInstance.isAirBlock(l3, k4, j4))
                                    {
                                        continue label222;
                                    }
                                }
        ...
        for (k2 = -1; k2 <= 1; ++k2)
        {
            for (i3 = 1; i3 < 3; ++i3)
            {
                for (l2 = -1; l2 < 3; ++l2)
                {
                    ...
                    i4 = j2 + (i3 - 1) * l5 - k2 * k5;
                    flag = l2 < 0;
                    this.worldServerInstance.setBlock(k3, j3, i4, Blocks.quartz_block);
                }
            }
        }
    }
    ...
    for (k2 = 0; k2 < 4; ++k2)
    {
        for (i3 = 0; i3 < 4; ++i3)
        {
            for (l2 = -1; l2 < 4; ++l2)
            {
                ...
                this.worldServerInstance.setBlock(k3, j3, i4, flag ? Blocks.quartz_block : FaithCraft2.HeavenPortal, 0, 2);
            }
        }
