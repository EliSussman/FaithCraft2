...
public class TileEntityHolyForge extends TileEntity implements ISidedInventory{
	...
	public void updateEntity() {
		...
		if(!this.worldObj.isRemote) {
			...
			if(flag != this.isBurning()) {
				flag1 = true;
				HolyForge.updateHolyForgeBlockState(this.burnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
			}
		}
		if(flag1) {
			this.markDirty();
