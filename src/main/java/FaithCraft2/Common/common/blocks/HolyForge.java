...
public class HolyForge extends BlockContainer{
	...
	public void registerBlockIcons(IIconRegister iconRegister){
		this.blockIcon = iconRegister.registerIcon(FaithCraft2.modid + ":" + "HolyForge_side");
		this.iconFront = iconRegister.registerIcon(FaithCraft2.modid + ":" + (this.isActive ? "HolyForge_front_on" : "HolyForge_front_off"));
		this.iconTop = iconRegister.registerIcon(FaithCraft2.modid + ":" + "HolyForge_top");
	}
	...
	public TileEntity createNewTileEntity(World var1, int var2) {
		return new TileEntityHolyForge();
	}
	...
	public void breakBlock(World world, int x, int y, int z, Block oldblock, int oldMetadata) {
		if(!keepinventory) {
			TileEntityHolyForge tileentity = (TileEntityHolyForge) world.getTileEntity(x, y, z);
