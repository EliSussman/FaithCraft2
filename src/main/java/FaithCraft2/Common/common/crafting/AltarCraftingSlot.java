...
public class AltarCraftingSlot extends Slot
{
    ...
    public AltarCraftingSlot(EntityPlayer player, InventoryCrafting craftingInventory, IInventory p_i45790_3_, int slotIndex, int xPosition, int yPosition)
    {
